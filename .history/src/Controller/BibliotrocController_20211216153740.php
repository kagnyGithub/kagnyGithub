...
class BibliotrocController extends AbstractController
{
    ...
    */
      public function commande(Livres $livre, LivresRepository $repo, CategoriesRepository $repoCategorie, PossederRepository $possede){
        $categories=$repoCategorie->findAll();
        $membrePosseder=$possede->find(['livre'=>$livre]);
        $membrePosseder->getUser()->getUsername();
